package com.breezedealmatrix.features.commondialogsinglebtn
...
import com.breezedealmatrix.app.domain.ShopVisitCompetetorModelEntity
import com.breezedealmatrix.app.domain.VisitRemarksEntity
...
import com.breezedealmatrix.features.addshop.presentation.ProspectListDialog
import com.breezedealmatrix.features.dashboard.presentation.DashboardActivity
import com.breezedealmatrix.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezedealmatrix.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezedealmatrix/files", "recorded_audio${System.currentTimeMillis()}.mp3")
