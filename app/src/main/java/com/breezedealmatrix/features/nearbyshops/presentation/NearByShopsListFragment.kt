...
import com.breezedealmatrix.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezedealmatrix.app.utils.FTStorageUtils
import com.breezedealmatrix.app.utils.NotificationUtils
...
import com.breezedealmatrix.features.addshop.model.AssignedToShopListResponseModel
import com.breezedealmatrix.features.addshop.model.QuestionSubmit
import com.breezedealmatrix.features.addshop.model.UpdateAddrReq
import com.breezedealmatrix.features.addshop.model.UpdateAddressShop
...
import com.breezedealmatrix.features.addshop.presentation.*
...
import com.breezedealmatrix.features.location.model.ShopDurationRequestData
...
import com.breezedealmatrix.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezedealmatrix.features.marketing.model.MarketingCategoryListResponse
...
import com.breezedealmatrix.features.nearbyshops.model.StageListResponseModel
...
import com.breezedealmatrix.features.shopdetail.presentation.AddCollectionDialog
...
import com.breezedealmatrix.features.viewAllOrder.interf.QaOnCLick
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezedealmatrixApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
