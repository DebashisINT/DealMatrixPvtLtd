package com.breezedealmatrix.features.dashboard.presentation
...
import com.breezedealmatrix.*
import com.breezedealmatrix.R
import com.breezedealmatrix.app.*
import com.breezedealmatrix.app.NewFileUtils.browseDocuments
import com.breezedealmatrix.app.NewFileUtils.browsePDFDocuments
import com.breezedealmatrix.app.NewFileUtils.getExtension
import com.breezedealmatrix.app.domain.*
import com.breezedealmatrix.app.types.DashboardType
import com.breezedealmatrix.app.types.FragType
import com.breezedealmatrix.app.types.TopBarConfig
import com.breezedealmatrix.app.uiaction.DisplayAlert
import com.breezedealmatrix.app.utils.*
import com.breezedealmatrix.app.utils.AppUtils.Companion.isProfile
import com.breezedealmatrix.base.BaseResponse
import com.breezedealmatrix.base.presentation.BaseActivity
import com.breezedealmatrix.base.presentation.BaseFragment
import com.breezedealmatrix.features.NewQuotation.*
import com.breezedealmatrix.features.NewQuotation.api.GetQuotRegProvider
import com.breezedealmatrix.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezedealmatrix.features.SearchLocation.SearchLocationFragment
import com.breezedealmatrix.features.SearchLocation.locationInfoModel
import com.breezedealmatrix.features.TA.ViewAllTAListFragment
import com.breezedealmatrix.features.achievement.AchievementFragment
import com.breezedealmatrix.features.activities.presentation.*
import com.breezedealmatrix.features.addAttendence.*
import com.breezedealmatrix.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezedealmatrix.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezedealmatrix.features.addAttendence.model.GetReportToFCMResponse
import com.breezedealmatrix.features.addAttendence.model.GetReportToResponse
import com.breezedealmatrix.features.addAttendence.model.Leave_list_Response
import com.breezedealmatrix.features.addorder.presentation.AddOrderFragment
...
import com.breezedealmatrix.features.addshop.presentation.AddShopFragment
import com.breezedealmatrix.features.addshop.presentation.OTPVerificationDialog
import com.breezedealmatrix.features.addshop.presentation.ScanImageFragment
import com.breezedealmatrix.features.addshop.presentation.ShowCardDetailsDialog
import com.breezedealmatrix.features.alarm.model.AlarmData
import com.breezedealmatrix.features.alarm.presetation.AttendanceReportFragment
import com.breezedealmatrix.features.alarm.presetation.PerformanceReportFragment
import com.breezedealmatrix.features.alarm.presetation.VisitReportDetailsFragment
import com.breezedealmatrix.features.alarm.presetation.VisitReportFragment
import com.breezedealmatrix.features.attendance.AttendanceFragment
import com.breezedealmatrix.features.attendance.api.AttendanceRepositoryProvider
import com.breezedealmatrix.features.attendance.model.AttendanceRequest
import com.breezedealmatrix.features.attendance.model.AttendanceResponse
import com.breezedealmatrix.features.averageshop.presentation.AverageShopFragment
import com.breezedealmatrix.features.avgorder.presentation.AverageOrderFragment
import com.breezedealmatrix.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezedealmatrix.features.beatCustom.TeamBeatListFragment
import com.breezedealmatrix.features.billing.presentation.AddBillingFragment
import com.breezedealmatrix.features.billing.presentation.BillingDetailsFragment
import com.breezedealmatrix.features.billing.presentation.BillingListFragment
import com.breezedealmatrix.features.changepassword.presentation.ChangePasswordDialog
import com.breezedealmatrix.features.chat.model.ChatListDataModel
import com.breezedealmatrix.features.chat.model.ChatUserDataModel
import com.breezedealmatrix.features.chat.model.GroupUserDataModel
import com.breezedealmatrix.features.chat.presentation.*
import com.breezedealmatrix.features.chatbot.presentation.ChatBotFragment
import com.breezedealmatrix.features.chatbot.presentation.ChatBotShopListFragment
import com.breezedealmatrix.features.chatbot.presentation.ReportsFragment
import com.breezedealmatrix.features.chatbot.presentation.SelectLanguageDialog
import com.breezedealmatrix.features.commondialog.presentation.CommonDialog
import com.breezedealmatrix.features.commondialog.presentation.CommonDialogClickListener
import com.breezedealmatrix.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezedealmatrix.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezedealmatrix.features.commondialogsinglebtn.OnDialogClickListener
import com.breezedealmatrix.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezedealmatrix.features.contacts.ActivityDtlsFrag
import com.breezedealmatrix.features.contacts.AddOpptFrag
import com.breezedealmatrix.features.contacts.ContactDtls
import com.breezedealmatrix.features.contacts.ContactGr
import com.breezedealmatrix.features.contacts.ContactsAddFrag
import com.breezedealmatrix.features.contacts.ContactsFrag
import com.breezedealmatrix.features.contacts.SchedulerAddFormFrag
import com.breezedealmatrix.features.contacts.SchedulerViewFrag
import com.breezedealmatrix.features.contacts.TemplateAddFrag
import com.breezedealmatrix.features.contacts.TemplateViewFrag
import com.breezedealmatrix.features.contacts.ViewCrmOpptFrag
import com.breezedealmatrix.features.dailyPlan.prsentation.AllShopListFragment
import com.breezedealmatrix.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezedealmatrix.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezedealmatrix.features.damageProduct.ShopDamageProductListFrag
import com.breezedealmatrix.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezedealmatrix.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezedealmatrix.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezedealmatrix.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezedealmatrix.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezedealmatrix.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezedealmatrix.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezedealmatrix.features.dashboard.presentation.model.ContentListResponseModel
import com.breezedealmatrix.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezedealmatrix.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezedealmatrix.features.device_info.presentation.DeviceInfoListFragment
import com.breezedealmatrix.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezedealmatrix.features.document.DocumentRepoFeatureNewFragment
import com.breezedealmatrix.features.document.presentation.DocumentListFragment
import com.breezedealmatrix.features.document.presentation.DocumentTypeListFragment
import com.breezedealmatrix.features.document.presentation.OpenFileWebViewFragment
import com.breezedealmatrix.features.dymanicSection.presentation.AddDynamicFragment
import com.breezedealmatrix.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezedealmatrix.features.dymanicSection.presentation.DynamicListFragment
import com.breezedealmatrix.features.dymanicSection.presentation.EditDynamicFragment
import com.breezedealmatrix.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezedealmatrix.features.home.presentation.HomeFragment
import com.breezedealmatrix.features.homelocation.presentation.HomeLocationFragment
import com.breezedealmatrix.features.homelocation.presentation.HomeLocationMapFragment
import com.breezedealmatrix.features.know_your_state.KnowYourStateFragment
import com.breezedealmatrix.features.lead.LeadFrag
import com.breezedealmatrix.features.lead.ViewLeadFrag
import com.breezedealmatrix.features.leaderboard.LeaderBoardFrag
import com.breezedealmatrix.features.leaveapplynew.LeaveHome
import com.breezedealmatrix.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezedealmatrix.features.localshops.LocalShopListFragment
import com.breezedealmatrix.features.localshops.LocalShopListMapFragment
import com.breezedealmatrix.features.localshops.NearByShopsMapFragment
import com.breezedealmatrix.features.location.*
import com.breezedealmatrix.features.location.api.LocationRepoProvider
import com.breezedealmatrix.features.location.model.*
import com.breezedealmatrix.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezedealmatrix.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezedealmatrix.features.login.ShopFeedbackEntity
import com.breezedealmatrix.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezedealmatrix.features.login.presentation.LoginActivity
import com.breezedealmatrix.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezedealmatrix.features.logoutsync.presentation.LogoutSyncFragment
import com.breezedealmatrix.features.marketAssist.MarketAssistTabFrag
import com.breezedealmatrix.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezedealmatrix.features.marketAssist.ShopListMarketAssistFrag
import com.breezedealmatrix.features.marketing.presentation.MarketingPagerFragment
import com.breezedealmatrix.features.meetinglist.prsentation.MeetingListFragment
import com.breezedealmatrix.features.member.MapViewForTeamFrag
import com.breezedealmatrix.features.member.model.TeamLocDataModel
import com.breezedealmatrix.features.member.model.TeamShopListDataModel
import com.breezedealmatrix.features.member.presentation.*
import com.breezedealmatrix.features.menuBeat.MenuBeatFrag
import com.breezedealmatrix.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezedealmatrix.features.micro_learning.presentation.MicroLearningListFragment
import com.breezedealmatrix.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezedealmatrix.features.myallowancerequest.MyallowanceRequestFragment
import com.breezedealmatrix.features.myjobs.model.CustomerDataModel
import com.breezedealmatrix.features.myjobs.presentation.*
import com.breezedealmatrix.features.mylearning.MyLearningFragment
import com.breezedealmatrix.features.myorder.presentation.MyOrderListFragment
import com.breezedealmatrix.features.myprofile.presentation.MyProfileFragment
import com.breezedealmatrix.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezedealmatrix.features.nearbyshops.model.ShopData
import com.breezedealmatrix.features.nearbyshops.model.ShopListResponse
import com.breezedealmatrix.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezedealmatrix.features.nearbyshops.presentation.BeatListFragment
import com.breezedealmatrix.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezedealmatrix.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezedealmatrix.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezedealmatrix.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezedealmatrix.features.newcollection.CollectionDetailsStatusFragment
import com.breezedealmatrix.features.newcollection.CollectionShopListFragment
import com.breezedealmatrix.features.newcollection.NewCollectionListFragment
import com.breezedealmatrix.features.newcollectionreport.*
import com.breezedealmatrix.features.notification.NotificationFragment
import com.breezedealmatrix.features.orderITC.CartListFrag
import com.breezedealmatrix.features.orderITC.OrderListFrag
import com.breezedealmatrix.features.orderITC.ProductListFrag
import com.breezedealmatrix.features.orderITC.ViewNewOrdHisAllFrag
import com.breezedealmatrix.features.orderITC.ViewNewOrdHistoryFrag
import com.breezedealmatrix.features.orderITC.ViewOrdDtls
import com.breezedealmatrix.features.orderList.NewDateWiseOrderListFragment
import com.breezedealmatrix.features.orderList.NewOrderListFragment
import com.breezedealmatrix.features.orderList.OrderListFragment
import com.breezedealmatrix.features.orderdetail.presentation.OrderDetailFragment
import com.breezedealmatrix.features.orderhistory.ActivityMapFragment
import com.breezedealmatrix.features.orderhistory.OrderhistoryFragment
import com.breezedealmatrix.features.orderhistory.TimeLineFragment
import com.breezedealmatrix.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezedealmatrix.features.orderhistory.model.FetchLocationRequest
import com.breezedealmatrix.features.orderhistory.model.FetchLocationResponse
import com.breezedealmatrix.features.orderhistory.model.LocationData
import com.breezedealmatrix.features.pendinglocationinout.PendingOutLocationFrag
import com.breezedealmatrix.features.performance.GpsStatusFragment
import com.breezedealmatrix.features.performance.PerformanceFragment
import com.breezedealmatrix.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezedealmatrix.features.performance.model.UpdateGpsInputParamsModel
import com.breezedealmatrix.features.performanceAPP.OwnPerformanceFragment
import com.breezedealmatrix.features.performanceAPP.PerformanceAppFragment
import com.breezedealmatrix.features.performanceAPP.allPerformanceFrag
import com.breezedealmatrix.features.permissionList.ViewPermissionFragment
import com.breezedealmatrix.features.photoReg.*
import com.breezedealmatrix.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezedealmatrix.features.quotation.presentation.*
import com.breezedealmatrix.features.reimbursement.presentation.*
import com.breezedealmatrix.features.report.presentation.*
import com.breezedealmatrix.features.returnsOrder.*
import com.breezedealmatrix.features.settings.presentation.SettingsFragment
import com.breezedealmatrix.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezedealmatrix.features.shopdetail.presentation.*
import com.breezedealmatrix.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezedealmatrix.features.stock.StockDetailsFragment
import com.breezedealmatrix.features.stock.StockListFragment
import com.breezedealmatrix.features.stockAddCurrentStock.AddShopStockFragment
import com.breezedealmatrix.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezedealmatrix.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezedealmatrix.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezedealmatrix.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezedealmatrix.features.stockCompetetorStock.CompetetorStockFragment
import com.breezedealmatrix.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezedealmatrix.features.survey.SurveyFrag
import com.breezedealmatrix.features.survey.SurveyViewDtlsFrag
import com.breezedealmatrix.features.survey.SurveyViewFrag
import com.breezedealmatrix.features.task.presentation.AddTaskFragment
import com.breezedealmatrix.features.task.presentation.CalenderTaskFragment
import com.breezedealmatrix.features.task.presentation.EditTaskFragment
import com.breezedealmatrix.features.task.presentation.TaskListFragment
import com.breezedealmatrix.features.taskManagement.TaskManagementFrag
import com.breezedealmatrix.features.taskManagement.ViewTaskManagementFrag
import com.breezedealmatrix.features.timesheet.presentation.AddTimeSheetFragment
import com.breezedealmatrix.features.timesheet.presentation.EditTimeSheetFragment
import com.breezedealmatrix.features.timesheet.presentation.TimeSheetListFragment
import com.breezedealmatrix.features.viewAllOrder.CartFragment
import com.breezedealmatrix.features.viewAllOrder.OrderTypeListFragment
import com.breezedealmatrix.features.viewAllOrder.ViewAllOrderListFragment
import com.breezedealmatrix.features.viewAllOrder.ViewCartFragment
import com.breezedealmatrix.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezedealmatrix.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezedealmatrix.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezedealmatrix.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezedealmatrix.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezedealmatrix.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezedealmatrix.features.viewPPDDStock.ViewOutstandingFragment
import com.breezedealmatrix.features.viewPPDDStock.ViewPPDDListFragment
import com.breezedealmatrix.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezedealmatrix.features.viewPPDDStock.ViewStockFragment
import com.breezedealmatrix.features.weather.presentation.WeatherFragment
import com.breezedealmatrix.mappackage.MapActivity
import com.breezedealmatrix.mappackage.MapActivityWithoutPath
import com.breezedealmatrix.mappackage.SendBrod
import com.breezedealmatrix.widgets.AppCustomEditText
import com.breezedealmatrix.widgets.AppCustomTextView
...
import com.breezedealmatrix.features.login.api.opportunity.OpportunityRepoProvider
import com.breezedealmatrix.features.login.model.NewSettingsResponseModel
import com.breezedealmatrix.features.mylearning.AllTopicsWiseContents
import com.breezedealmatrix.features.mylearning.BookmarkFetchResponse
import com.breezedealmatrix.features.mylearning.BookmarkFrag
import com.breezedealmatrix.features.mylearning.BookmarkPlayFrag
import com.breezedealmatrix.features.mylearning.KnowledgeHubAllVideoList
import com.breezedealmatrix.features.mylearning.LeaderboardLmsFrag
import com.breezedealmatrix.features.mylearning.LmsQuestionAnswerSet
import com.breezedealmatrix.features.mylearning.MyLearningAllVideoList
import com.breezedealmatrix.features.mylearning.MyLearningTopicList
import com.breezedealmatrix.features.mylearning.MyLearningVideoPlay
import com.breezedealmatrix.features.mylearning.MyPerformanceFrag
import com.breezedealmatrix.features.mylearning.MyTopicsWiseContents
import com.breezedealmatrix.features.mylearning.NotificationLMSFragment
import com.breezedealmatrix.features.mylearning.SearchLmsFrag
import com.breezedealmatrix.features.mylearning.SearchLmsKnowledgeFrag
import com.breezedealmatrix.features.mylearning.SearchLmsLearningFrag
import com.breezedealmatrix.features.mylearning.VideoPlayLMS
import com.breezedealmatrix.features.mylearning.apiCall.LMSRepoProvider
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezedealmatrixlogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedealmatrixlogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezedealmatrix/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezedealmatrixlogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezedealmatrixlogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezedealmatrixlogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
