package com.breezedealmatrix.features.logoutsync.presentation
...
import com.breezedealmatrix.CustomConstants


import com.breezedealmatrix.R
import com.breezedealmatrix.app.AppDatabase
...
import com.breezedealmatrix.app.utils.Toaster
import com.breezedealmatrix.base.BaseResponse
import com.breezedealmatrix.base.presentation.BaseActivity
import com.breezedealmatrix.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezedealmatrix.features.billing.api.AddBillingRepoProvider
import com.breezedealmatrix.features.billing.model.AddBillingInputParamsModel
...
import com.breezedealmatrix.features.dashboard.presentation.ReasonDialog
...
import com.breezedealmatrix.features.document.model.AddEditDocumentInputParams
import com.breezedealmatrix.features.document.model.DocumentAttachmentModel
...
import com.breezedealmatrix.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezedealmatrix.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezedealmatrix.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezedealmatrix.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezedealmatrix.features.orderhistory.model.*
...
import com.breezedealmatrix.features.quotation.model.AddQuotInputModel
import com.breezedealmatrix.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezedealmatrix.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezedealmatrix.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezedealmatrix.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezedealmatrix.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezedealmatrix.features.timesheet.model.AddTimeSheetInputModel
import com.breezedealmatrix.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezedealmatrix.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezedealmatrix.features.viewAllOrder.model.AddOrderInputProductList
import com.breezedealmatrix.mappackage.SendBrod
import com.breezedealmatrix.widgets.AppCustomTextView
import com.breezedealmatrix.MonitorService
import com.breezedealmatrix.MySingleton
import com.breezedealmatrix.app.AlarmReceiver
...
import com.breezedealmatrix.features.addshop.presentation.ShopExtraContactReq
...
import com.breezedealmatrix.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezedealmatrix.features.login.model.GetConcurrentUserResponse
...
import com.breezedealmatrix.features.orderITC.SyncDeleteOpptL
import com.breezedealmatrix.features.orderITC.SyncEditOppt
import com.breezedealmatrix.features.orderITC.SyncOppt
import com.breezedealmatrix.features.orderITC.SyncOpptProductL
import com.breezedealmatrix.features.orderITC.SyncOrd
import com.breezedealmatrix.features.orderITC.SyncOrdProductL
import com.breezedealmatrix.features.performance.model.Gps_status_list
import com.breezedealmatrix.features.performance.model.UpdateGpsInputListParamsModel
import com.breezedealmatrix.features.returnsOrder.ReturnProductList
import com.breezedealmatrix.features.returnsOrder.ReturnRequest
import com.breezedealmatrix.features.viewAllOrder.model.NewOrderSaveApiModel
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezedealmatrix/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedealmatrixlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedealmatrixlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedealmatrixlogsample/log.zip").path);
